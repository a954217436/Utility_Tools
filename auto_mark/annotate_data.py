...
# 加载标签名称
classesFile = "home_bj_cfg/yolov3_home_bj_25.names" # 标签文件的路径
classes = None
# 将voc.names文件中的标签名称放入classes变量中
with open(classesFile, 'rt') as f:
    classes = f.read().rstrip('\n').split('\n') 

modelConfiguration = "home_bj_cfg/yolov3_home_bj_25.cfg" # 配置文件的路径
modelWeights = "home_bj_cfg/yolov3_home_bj_25.weights" # 模型权重的路径
...
img_path='/home/lm/Sample_And_Labels/Annotate_data/bj_eight_floor/imgs' # 需要自动标注图片的路径
...
for i in range(len(image)):
    ...
    # 存放自动标注完生成的.xml路径
    xml_savepath ='/home/lm/Sample_And_Labels/Annotate_data/bj_eight_floor/xmls'  
